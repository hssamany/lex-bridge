...
<div id="line-items-filter-container">
    ...
    <button type="button" id="send-invoice-btn" class="btn btn-success" style="height: 40px; width: 40px; display: flex; align-items: center; justify-content: center; margin-top: 32px; font-size: 1.3rem;" disabled title="Ausgewählte Positionen als Rechnung erstellen">
